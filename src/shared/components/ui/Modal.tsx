  ...
  return (
    ...
    >
      <div
        ...
        className={`bg-white shadow-2xl overflow-y-auto flex flex-col ${sizeClasses[size]}`}
      >
        <div className="flex items-center justify-between gap-3 px-6 py-4 border-b border-slate-100 sticky top-0 bg-white z-10">
          <div className="flex items-center gap-3 min-w-0">
            <h3 id={titleId} className="text-lg font-bold text-slate-800 shrink-0">{title}</h3>
